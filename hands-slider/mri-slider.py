...
while True:
	...
	# Show MRI Images
	mriImage = str(int(finalRange)) + ".dcm"
	filename = "scans/" + mriImage
	ds = pydicom.read_file(filename)
	image2 = ds.pixel_array
	image2 = exposure.equalize_adapthist(image2)

	cv2.imshow("MRI Scans", image2)
	cv2.moveWindow("MRI Scans", 700,50)
